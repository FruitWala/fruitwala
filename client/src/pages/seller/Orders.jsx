    ...
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll">
      ...
      <div className="p-4 md:p-10 space-y-6">
        ...
        {orders.map((order) => (
          ...
          <div
            key={order._id}
            className="border border-gray-300 rounded-lg p-4 md:p-6 space-y-4 bg-white"
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                {order.items?.map((item, idx) => (
                  ...
                  <p key={idx} className="font-medium text-sm text-gray-800">
                ...
                {order.paymentType === "COD" &&
                  ...
                  order.status !== "Cancelled" && (
                    ...
                    <button
                      ...
                      className="mt-3 w-full bg-green-600 text-white py-1.5 rounded text-sm hover:bg-green-700 transition"
                    >
